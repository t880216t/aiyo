...
## Purpose
This module contains tunnel provider orchestration for AiYo, including provider registry/service wiring, managed remote token config lifecycle, and tunnel HTTP route registration.

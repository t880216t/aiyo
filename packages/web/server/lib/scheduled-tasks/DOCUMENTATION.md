...
Server-owned scheduled task runtime and routes for AiYo-only automation.
...
- This module is AiYo feature logic; it is intentionally separate from OpenCode proxy/runtime internals.
...
- Registers:
  ...
  - `GET /api/aiyo/scheduled-tasks/status`
  - `GET /api/aiyo/events`

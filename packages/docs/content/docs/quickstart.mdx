---
title: Quickstart
description: Start AiYo quickly and pick the right app for the task.
---
...
2. Install the AiYo CLI (see [Install](/install/) for the one-line command).
...
You should see the AiYo session list in your browser. If it loads, you're up and running.

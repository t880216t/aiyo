---
title: Reverse Proxy
description: Configure AiYo correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run AiYo behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.

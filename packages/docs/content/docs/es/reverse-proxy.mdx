---
title: Proxy inverso
description: Configura AiYo correctamente detrás de Nginx, Nginx Proxy Manager u otro proxy inverso.
---

# Proxy inverso

Usa esta página si ejecutas AiYo detrás de Nginx, Nginx Proxy Manager, Caddy, Cloudflare u otro proxy inverso.

## Antes de ponerle un proxy

1. Confirma primero que AiYo funciona directamente.
...
- Desactiva gzip en el proxy si AiYo ya comprime las respuestas.
...
- AiYo accesible directamente en la LAN
...
- AiYo comprime las respuestas HTTP con gzip (umbral de 1 KB).
...
Las rutas de streaming SSE están excluidas de la compresión por AiYo, pero la CDN aún puede almacenarlas en búfer. Consulta la documentación de tu CDN para saber cómo desactivar el búfer en las rutas SSE.

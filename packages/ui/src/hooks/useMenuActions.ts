...
const MENU_ACTION_EVENT = 'aiyo:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'aiyo:check-for-updates';
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('aiyo:copy', { cancelable: true });

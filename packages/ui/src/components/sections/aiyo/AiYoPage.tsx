...
import { AiYoVisualSettings } from './AiYoVisualSettings';
...
import type { AiYoSection } from './types';
...
export const AiYoPage: React.FC<AiYoPageProps> = ({ section }) => {
    ...
    if (!section) {
        return (
            <ScrollableOverlay
                ...
                className="w-full"
            >
                <div className="aiyo-page-body mx-auto max-w-3xl space-y-3 p-3 sm:space-y-6 sm:p-6 sm:pt-8">
                    <AiYoVisualSettings />
    ...
    return (
        <ScrollableOverlay
            ...
            className="w-full"
        >
            <div className="aiyo-page-body mx-auto max-w-3xl space-y-6 p-3 sm:p-6 sm:pt-8">
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <AiYoVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'pwaOrientation',
        'mobileKeyboardMode',

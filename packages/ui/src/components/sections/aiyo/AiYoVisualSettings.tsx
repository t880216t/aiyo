...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.aiyo.visual.option.themeMode.system',
    },
    {
        value: 'light',
        labelKey: 'settings.aiyo.visual.option.themeMode.light',
    },
    {
        value: 'dark',
        labelKey: 'settings.aiyo.visual.option.themeMode.dark',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.aiyo.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.aiyo.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.aiyo.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.aiyo.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.aiyo.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.aiyo.visual.option.diffLayout.sideBySide.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.aiyo.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.aiyo.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.aiyo.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.aiyo.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'AiYo - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.aiyo.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.aiyo.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.aiyo.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.aiyo.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.aiyo.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.aiyo.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.aiyo.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.aiyo.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.aiyo.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.aiyo.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];
...
const MOBILE_LAYOUT_OPTIONS: Array<{ value: MobileLayoutPreference; labelKey: string }> = [
    {
        value: 'default',
        labelKey: 'settings.aiyo.visual.option.mobileLayout.default',
    },
    {
        value: 'new',
        labelKey: 'settings.aiyo.visual.option.mobileLayout.new',
    },
];

type PwaInstallNameWindow = Window & {
    __AIYO_SET_PWA_INSTALL_NAME__?: (value: string) => string;
    __AIYO_SET_PWA_ORIENTATION__?: (value: 'system' | 'portrait' | 'landscape') => 'system' | 'portrait' | 'landscape';
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.aiyo.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.aiyo.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.aiyo.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.aiyo.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.aiyo.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.aiyo.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.aiyo.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.aiyo.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.aiyo.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.aiyo.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.aiyo.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.aiyo.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.aiyo.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.aiyo.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.aiyo.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.aiyo.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.aiyo.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.aiyo.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.aiyo.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.aiyo.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.aiyo.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.aiyo.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.aiyo.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.aiyo.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.aiyo.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.aiyo.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.aiyo.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.aiyo.visual.option.weekStart.sunday.label',
    },
];
...
interface AiYoVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const AiYoVisualSettings: React.FC<AiYoVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const macVibrancySupported = React.useMemo(
        () => isDesktopShell() && typeof window !== 'undefined' && window.__AIYO_ELECTRON__?.macVibrancySupported === true,
        [],
    );
    const macVibrancyEnabled = typeof window !== 'undefined' && window.__AIYO_ELECTRON__?.macVibrancy === true;
    ...
    const handleFileViewerPreviewChange = React.useCallback((enabled: boolean) => {
        ...
        window.dispatchEvent(new CustomEvent('aiyo:file-viewer-preview-mode-changed', { detail: { enabled } }));
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.aiyo.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.aiyo.visual.option.weekStart.auto.label');
    ...
    const applyPwaInstallName = React.useCallback(async (value: string) => {
        ...
        if (typeof win.__AIYO_SET_PWA_INSTALL_NAME__ === 'function') {
            const resolved = win.__AIYO_SET_PWA_INSTALL_NAME__(persistedValue);
    ...
    const applyPwaOrientation = React.useCallback(async (value: 'system' | 'portrait' | 'landscape') => {
        ...
        if (typeof win.__AIYO_SET_PWA_ORIENTATION__ === 'function') {
            const resolved = win.__AIYO_SET_PWA_ORIENTATION__(normalized);
        ...
        <div className="space-y-8">
                ...
                {hasAppearanceSettings && (
                    <div className="mb-8 space-y-6">
                        {hasThemeSettings && (
                            <section className="px-2 pb-2 pt-0 space-y-2">
                                <div className="flex min-w-0 flex-col gap-1.5">
                                    <span className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.colorMode')}</span>
                                ...
                                {showMobileLayoutSetting && (
                                    <div className="flex min-w-0 flex-col gap-1.5 py-1.5">
                                        <span className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.mobileLayout')}</span>
                                        <div className="flex flex-wrap items-center gap-1">
                                ...
                                <div className="grid grid-cols-1 gap-2 py-1.5 md:grid-cols-[14rem_auto] md:gap-x-8 md:gap-y-2">
                                    <div data-settings-item="appearance.light-theme" className="flex min-w-0 items-center gap-2">
                                        <span className="typography-ui-label text-foreground shrink-0">{t('settings.aiyo.visual.field.lightTheme')}</span>
                                        <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                            <SelectTrigger aria-label={t('settings.aiyo.visual.field.selectLightThemeAria')} className="w-fit">
                                                <SelectValue placeholder={t('settings.aiyo.visual.field.selectThemePlaceholder')}>
                                                    {selectedLightTheme
                                    ...
                                    <div data-settings-item="appearance.dark-theme" className="flex min-w-0 items-center gap-2">
                                        <span className="typography-ui-label text-foreground shrink-0">{t('settings.aiyo.visual.field.darkTheme')}</span>
                                        <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                            <SelectTrigger aria-label={t('settings.aiyo.visual.field.selectDarkThemeAria')} className="w-fit">
                                                <SelectValue placeholder={t('settings.aiyo.visual.field.selectThemePlaceholder')}>
                                                    {selectedDarkTheme
                                ...
                                <div className="flex items-center gap-2 py-1.5">
                                    ...
                                    >
                                        {themesReloading ? t('settings.aiyo.visual.actions.reloadingThemes') : t('settings.aiyo.visual.actions.reloadThemes')}
                                    </button>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <button
                                                ...
                                                aria-label={t('settings.aiyo.visual.field.themeImportInfoAria')}
                                            >
                                                <Icon name="information" className="h-3.5 w-3.5" />
                                            </button>
                                        </TooltipTrigger>
                                        <TooltipContent sideOffset={8}>
                                            {t('settings.aiyo.visual.field.themeImportInfoTooltip')}
                                        </TooltipContent>
                                    </Tooltip>
                                </div>
                                    ...
                                    <div data-settings-item="appearance.window-transparency" className="flex flex-col gap-1.5 border-t border-border/40 pt-3">
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.macVibrancy')}
                                            />
                                            <div className="flex min-w-0 flex-col">
                                                <span className="typography-ui-label text-foreground">
                                                    {t('settings.aiyo.visual.field.macVibrancy')}
                                                </span>
                                                <span className="typography-meta text-muted-foreground">
                                                    {t('settings.aiyo.visual.field.macVibrancyHint')}
                                                </span>
                                            </div>
                                        </div>
                                        {vibrancyChecked !== macVibrancyEnabled && (
                                            <div className="pl-6">
                                                ...
                                                >
                                                    {vibrancyRestarting
                                                        ? t('settings.aiyo.visual.actions.restarting')
                                                        : t('settings.aiyo.visual.actions.saveAndRestart')}
                                                </Button>
                                            </div>
                                        )}
                                    </div>
                        ...
                        {hasLocalizationSettings && (
                            <section className="px-2 pb-2 pt-0 space-y-2">
                                <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.localization')}</h4>
                                    ...
                                    <div className="grid grid-cols-1 gap-2 py-1.5 md:grid-cols-[14rem_auto] md:gap-x-8 md:gap-y-2">
                                        {shouldShow('timeFormat') && (
                                            <div data-settings-item="appearance.time-format" className="flex min-w-0 items-center gap-2">
                                                <span className="typography-ui-label text-foreground shrink-0">{t('settings.aiyo.visual.field.timeFormat')}</span>
                                                <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                    <SelectTrigger aria-label={t('settings.aiyo.visual.field.selectTimeFormatAria')} className="w-fit">
                                        ...
                                        {shouldShow('weekStart') && (
                                            <div data-settings-item="appearance.week-start" className="flex min-w-0 items-center gap-2">
                                                <span className="typography-ui-label text-foreground shrink-0">{t('settings.aiyo.visual.field.weekStartsOn')}</span>
                                                <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                    <SelectTrigger aria-label={t('settings.aiyo.visual.field.selectWeekStartAria')} className="w-fit">
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            ...
                            {showPwaInstallNameSetting && (
                                <div data-settings-item="appearance.pwa-install-name" className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.installAppName')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.aiyo.visual.field.installAppNameHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[28rem] items-center gap-2">
                                        <Input
                                            ...
                                            className="h-7"
                                            maxLength={64}
                                            aria-label={t('settings.aiyo.visual.field.pwaInstallAppNameAria')}
                                        />
                                        <Button size="sm"
                                            type="button"
                                            variant="ghost"
                                            ...
                                            aria-label={t('settings.aiyo.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <div data-settings-item="appearance.pwa-orientation" className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.installOrientation')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.aiyo.visual.field.installOrientationHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[18rem] items-center gap-2">
                                        ...
                                        >
                                            <SelectTrigger aria-label={t('settings.aiyo.visual.field.pwaInstallOrientationAria')} className="w-full">
                                                <SelectValue placeholder={t('settings.aiyo.visual.field.selectOrientationPlaceholder')}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetInstallOrientationAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <div data-settings-item="appearance.mobile-keyboard-mode" className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.mobileKeyboardMode')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.aiyo.visual.field.mobileKeyboardModeHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[18rem] items-center gap-2">
                                        <Select
                                        ...
                                        >
                                            <SelectTrigger aria-label={t('settings.aiyo.visual.field.mobileKeyboardModeAria')} className="w-full">
                                                <SelectValue placeholder={t('settings.aiyo.visual.field.selectMobileKeyboardModePlaceholder')}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetMobileKeyboardModeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                ...
                {hasLayoutSettings && (
                    <div className="mb-8 space-y-3">
                        <section className="p-2 space-y-0.5">
                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.spacingAndLayout')}</h4>
                            <div className="pl-2">
                            ...
                            {shouldShow('fontSize') && !isMobile && (
                                <div data-settings-item="appearance.interface-font-size" className="flex items-center gap-8 py-1">
                                    <div className="flex min-w-0 flex-col w-56 shrink-0">
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.interfaceFont')}</span>
                                    </div>
                                    <div className="flex items-center gap-2 w-fit">
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.aiyo.visual.field.selectInterfaceFontAria')} className="w-[13rem]">
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('terminalFontSize') && (
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.codeFont')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.aiyo.visual.field.selectCodeFontAria')} className="w-[13rem]">
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('fontSize') && !isMobile && (
                                <div className="flex items-center gap-8 py-1">
                                    <div className="flex min-w-0 flex-col w-56 shrink-0">
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.interfaceFontSize')}</span>
                                    </div>
                                    <div className="flex items-center gap-2 w-fit">
                                        <NumberInput
                                            value={fontSize}
                                            ...
                                            max={200}
                                            step={5}
                                            aria-label={t('settings.aiyo.visual.field.fontSizePercentageAria')}
                                            className="w-16"
                                        />
                                        <Button size="sm"
                                            type="button"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('terminalFontSize') && (
                                <div data-settings-item="appearance.terminal-font-size" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.terminalFontSize')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetTerminalFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('spacing') && (
                                <div data-settings-item="appearance.spacing-density" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.spacingDensity')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                            value={padding}
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetSpacingAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                <div data-settings-item="appearance.input-bar-offset" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <div className="flex items-center gap-1.5">
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.inputBarOffset')}</span>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                                </TooltipTrigger>
                                                <TooltipContent sideOffset={8} className="max-w-xs">
                                                    {t('settings.aiyo.visual.field.inputBarOffsetTooltip')}
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.aiyo.visual.actions.resetInputBarOffsetAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                ...
                {hasNavigationSettings && (
                    <div className="space-y-3">
                        <section className="px-2 pb-2 pt-0">
                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.navigation')}</h4>
                            {shouldShow('fileEditorKeymap') && (
                                <div data-settings-item="appearance.file-editor-keymap" className="flex flex-col gap-2 py-1.5 sm:flex-row sm:items-start sm:gap-8">
                                    <span className="typography-ui-label text-foreground sm:w-56 shrink-0">
                                        {t('settings.aiyo.visual.field.fileEditorKeymap')}
                                    </span>
                                    <div
                                        role="radiogroup"
                                        aria-label={t('settings.aiyo.visual.field.fileEditorKeymap')}
                                        className="space-y-0"
                                    >
                                        {(['default', 'vim'] as const).map((keymap) => {
                                            const selected = fileEditorKeymap === keymap;
                                            const labelText = t(`settings.aiyo.visual.option.fileEditorKeymap.${keymap}`);
                                            return (
                                                <button
                                                    key={keymap}
                                                    type="button"
                            ...
                            {shouldShow('expandedEditorToolbar') && (
                                ...
                                >
                                    <Checkbox
                                        ...
                                        ariaLabel={t('settings.aiyo.visual.field.expandedEditorToolbarAria')}
                                    />
                                    <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.expandedEditorToolbar')}</span>
                                </div>
                            )}
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                ...
                                >
                                    <Checkbox
                                        ...
                                        ariaLabel={t('settings.aiyo.visual.field.terminalQuickKeysAria')}
                                    />
                                    <div className="flex min-w-0 items-center gap-1.5">
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.terminalQuickKeys')}</span>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                            </TooltipTrigger>
                                            <TooltipContent sideOffset={8} className="max-w-xs">
                                                {t('settings.aiyo.visual.field.terminalQuickKeysTooltip')}
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-[minmax(0,16rem)_minmax(0,16rem)] md:justify-start md:gap-x-2">
                                    {shouldShow('chatRenderMode') && (
                                        <section data-settings-item="chat.render-mode" className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.chatRenderMode')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.aiyo.visual.section.chatRenderModeAria')} className="mt-1 grid w-full max-w-[26rem] grid-cols-1 gap-3 sm:grid-cols-2">
                                    ...
                                    {shouldShow('messageTransport') && (
                                        <section data-settings-item="chat.message-transport" className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.messageStreamTransport')}</h4>
                                    ...
                                    {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                        <section className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.activityDefault')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.aiyo.visual.section.activityDefaultAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.aiyo.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('expandedTools') && (
                                        <section className="p-2 md:col-span-2 space-y-0.5">
                                            <div className="typography-ui-header font-medium text-foreground py-1.5">{t('settings.aiyo.visual.section.showToolsOpenedByDefault')}</div>
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.aiyo.visual.field.showExpandedBashToolsAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.bash')}</span>
                                            </div>
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.aiyo.visual.field.showExpandedEditToolsAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.editTools')}</span>
                                            </div>
                                        </section>
                                    )}
                                    ...
                                    {shouldShow('userMessageRendering') && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.userMessageRendering')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.aiyo.visual.section.userMessageRenderingAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.aiyo.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.mermaidRendering')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.aiyo.visual.section.mermaidRenderingAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.aiyo.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.aiyo.visual.section.diffLayout')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.aiyo.visual.section.diffLayoutAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.aiyo.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('reasoning') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.showReasoningTracesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.showReasoningTraces')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('reasoning') && showReasoningTraces && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.collapsibleThinkingBlocks')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('collapsibleUserMessages') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.collapsibleUserMessagesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.collapsibleUserMessages')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('stickyUserHeader') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.stickyUserHeaderAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.stickyUserHeader')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('wideChatLayout') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.wideChatLayoutAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.wideChatLayout')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('splitAssistantMessageActions') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.showSplitAssistantMessageActionsAria')}
                                            />
                                            <div className="flex min-w-0 items-center gap-1.5">
                                                <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.showSplitAssistantMessageActions')}</span>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Icon name="information" className="h-3.5 w-3.5 cursor-help text-muted-foreground/60" />
                                                    </TooltipTrigger>
                                                    <TooltipContent sideOffset={8} className="max-w-xs">
                                                        {t('settings.aiyo.visual.field.showSplitAssistantMessageActionsTooltip')}
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </div>
                                    ...
                                    {shouldShow('showToolFileIcons') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.showToolFileIconsAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.showToolFileIcons')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('showTurnChangedFiles') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.showTurnChangedFilesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.showTurnChangedFiles')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.showDotfilesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.showDotfiles')}</span>
                                        </div>
                                    )}
                                        ...
                                        >
                                            <span onClick={(event) => event.stopPropagation()}>
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.aiyo.defaults.field.openFilesPreviewAria')}
                                                />
                                            </span>
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.defaults.field.openFilesPreview')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('queueMode') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.queueMessagesByDefaultAria')}
                                            />
                                            <div className="flex min-w-0 items-center gap-1.5">
                                                <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.queueMessagesByDefault')}</span>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                                    </TooltipTrigger>
                                                    <TooltipContent sideOffset={8} className="max-w-xs">
                                                        {t('settings.aiyo.visual.field.queueMessagesByDefaultTooltip', { modifier: getModifierLabel() })}
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </div>
                                    ...
                                    {shouldShow('persistDraft') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.persistDraftMessagesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.persistDraftMessages')}</span>
                                        </div>
                                    )}
                                    ...
                                    {!isMobile && shouldShow('inputSpellcheck') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.aiyo.visual.field.enableSpellcheckInTextInputsAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.enableSpellcheckInTextInputs')}</span>
                                        </div>
                                    )}
                ...
                {shouldShow('reportUsage') && (
                    <div className="space-y-3">
                        <section className="px-2 pb-2 pt-0">
                            <h4 className="typography-ui-header font-medium text-foreground mb-2">{t('settings.aiyo.visual.section.privacy')}</h4>
                            <div data-settings-item="appearance.usage-reports" className="flex items-start gap-2 py-1.5">
                                <Checkbox
                                    checked={reportUsage}
                                    onChange={handleReportUsageChange}
                                    ariaLabel={t('settings.aiyo.visual.field.sendAnonymousUsageReportsAria')}
                                />
                                <div className="flex min-w-0 flex-col gap-0.5">
                                    ...
                                    >
                                        <span className="typography-ui-label text-foreground">{t('settings.aiyo.visual.field.sendAnonymousUsageReports')}</span>
                                    </div>
                                    <span className="typography-meta text-muted-foreground pointer-events-none">
                                        {t('settings.aiyo.visual.field.sendAnonymousUsageReportsHint')}
                                    </span>
                                </div>
                            </div>
                        </section>

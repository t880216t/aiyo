  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'aiyo-ui://app', href: 'aiyo-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('aiyo-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');

...
export const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.macVibrancy',
    descriptionKey: 'settings.aiyo.visual.field.macVibrancyHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.installAppName',
    descriptionKey: 'settings.aiyo.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.installOrientation',
    descriptionKey: 'settings.aiyo.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.aiyo.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.inputBarOffset',
    descriptionKey: 'settings.aiyo.visual.field.inputBarOffsetTooltip',
    keywords: ['input', 'home bar', 'offset'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.expandedEditorToolbar',
    keywords: ['editor', 'toolbar', 'tabs', 'docked', 'files'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.terminal-quick-keys',
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.aiyo.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.aiyo.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.aiyo.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.reasoning-traces',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.collapsible-user-messages',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.aiyo.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.showDotfiles',
  ...
  },
  {
    id: 'chat.queue-mode',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.queueMessagesByDefault',
    descriptionKey: 'settings.aiyo.visual.field.queueMessagesByDefaultTooltip',
    keywords: ['queue', 'enter', 'send'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.aiyo.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.aiyo.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.aiyo.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.aiyo.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.aiyo.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.aiyo.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.aiyo.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.aiyo.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.aiyo.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'sessions',
    titleKey: 'settings.aiyo.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.aiyo.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.aiyo.desktopPassword.field.password',
    descriptionKey: 'settings.aiyo.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.aiyo.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.aiyo.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.aiyo.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.aiyo.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.aiyo.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.aiyo.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.aiyo.git.showGitignored',
  ...
  },
  {
    ...
    keywords: ['custom provider', 'openai compatible', 'base url', 'api key'],
  },
  {
    id: 'providers.auth',
    page: 'providers',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.aiyo.keyboardShortcuts.title',
    descriptionKey: 'settings.aiyo.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.aiyo.tunnel.field.provider',
    descriptionKey: 'settings.aiyo.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.aiyo.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.aiyo.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.aiyo.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.aiyo.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.aiyo.tunnel.field.configurationFile',
    descriptionKey: 'settings.aiyo.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.aiyo.tunnel.actions.startTunnel',
    descriptionKey: 'settings.aiyo.tunnel.note.connectLinksOneTime',

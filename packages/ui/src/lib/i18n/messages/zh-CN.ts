...
export const dict: Record<I18nKey, string> = {
  ...
  'common.save': '保存',
  'miniApps.title': '小程序',
  'miniApps.description': '在 AiYo 中打开配置的第三方网页。',
  'miniApps.empty': '还没有配置小程序。',
  'miniApps.loadError': '无法加载小程序。',
  'miniApps.form.name': '应用名称',
  'miniApps.form.url': 'https://example.com',
  'miniApps.form.iconUrl': '图标 URL（可选）',
  'miniApps.form.add': '添加小程序',
  'miniApps.form.invalid': '请输入名称和有效的 HTTP 或 HTTPS 地址。',
  'miniApps.form.invalidIconUrl': '图标 URL 必须是有效的 HTTP 或 HTTPS 地址。',
  'miniApps.actions.open': '打开 {name}',
  'miniApps.actions.edit': '编辑 {name}',
  'miniApps.actions.delete': '删除 {name}',
  'miniApps.actions.pin': '固定 {name} 到侧边栏',
  'miniApps.actions.unpin': '从侧边栏取消固定 {name}',
  'miniApps.actions.pinLimit': '最多固定 {count} 个小程序。',
  'miniApps.viewer.back': '后退',
  'miniApps.viewer.forward': '前进',
  'miniApps.viewer.reload': '刷新',
  'miniApps.viewer.openExternal': '在外部浏览器打开',
  'miniApps.viewer.openDevTools': '打开小程序控制台',
  'miniApps.viewer.minimize': '收起查看器',
  'miniApps.viewer.switchTo': '切换到 {name}',
  'miniApps.viewer.closeApp': '关闭 {name}',
  'miniApps.proxy.title': '网络代理',
  'miniApps.proxy.description': '在桌面端为小程序网页应用代理。',
  'miniApps.proxy.mode': '小程序代理模式',
  'miniApps.proxy.mode.none': '不使用代理',
  'miniApps.proxy.mode.system': '系统代理',
  'miniApps.proxy.mode.custom': '自定义代理',
  'miniApps.proxy.url': 'http://127.0.0.1:7890 或 socks5://127.0.0.1:1080',
  'miniApps.proxy.bypassRules': '绕过规则（可选）',
  'miniApps.proxy.invalidUrl': '代理 URL 必须使用 http、https、socks、socks4 或 socks5。',
  ...
  'sessions.sidebar.footer.actions.aboutAiYo': '关于 AiYo',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 AiYo 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 AiYo 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 AiYo',
  ...
  'header.actions.openAppMenu': 'AiYo 菜单',
  'header.actions.openAppMenuAria': '打开 AiYo 菜单',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 AiYo',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 AiYo 服务器之间切换',
  ...
  'multiRun.window.description': 'AiYo 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 AiYo',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 AiYo 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 AiYo 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 AiYo 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 AiYo 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 AiYo 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 AiYo。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 AiYo，但与此应用版本不兼容。请更新服务器上的 AiYo 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 AiYo。请确认地址是否指向 AiYo 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 AiYo。请确认地址是否指向 AiYo 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 AiYo 服务器与此应用版本不兼容。请更新服务器上的 AiYo 后重试。',
  ...
  'startup.initRecovery.description': 'AiYo 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：aiyo update',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 AiYo 打开。',

...
export const dict: Record<I18nKey, string> = {
  ...
  'common.save': '儲存',
  'miniApps.title': '小程式',
  'miniApps.description': '在 AiYo 中開啟設定的第三方網頁。',
  'miniApps.empty': '尚未設定小程式。',
  'miniApps.loadError': '無法載入小程式。',
  'miniApps.form.name': '應用程式名稱',
  'miniApps.form.url': 'https://example.com',
  'miniApps.form.iconUrl': '圖示 URL（選填）',
  'miniApps.form.add': '新增小程式',
  'miniApps.form.invalid': '請輸入名稱和有效的 HTTP 或 HTTPS 網址。',
  'miniApps.form.invalidIconUrl': '圖示 URL 必須是有效的 HTTP 或 HTTPS 網址。',
  'miniApps.actions.open': '開啟 {name}',
  'miniApps.actions.edit': '編輯 {name}',
  'miniApps.actions.delete': '刪除 {name}',
  'miniApps.actions.pin': '固定 {name} 到側邊欄',
  'miniApps.actions.unpin': '從側邊欄取消固定 {name}',
  'miniApps.actions.pinLimit': '最多固定 {count} 個小程式。',
  'miniApps.viewer.back': '上一頁',
  'miniApps.viewer.forward': '下一頁',
  'miniApps.viewer.reload': '重新整理',
  'miniApps.viewer.openExternal': '在外部瀏覽器開啟',
  'miniApps.viewer.openDevTools': '開啟小程式主控台',
  'miniApps.viewer.minimize': '收合檢視器',
  'miniApps.viewer.switchTo': '切換到 {name}',
  'miniApps.viewer.closeApp': '關閉 {name}',
  'miniApps.proxy.title': '網路代理',
  'miniApps.proxy.description': '在桌面端為小程式網頁套用代理。',
  'miniApps.proxy.mode': '小程式代理模式',
  'miniApps.proxy.mode.none': '不使用代理',
  'miniApps.proxy.mode.system': '系統代理',
  'miniApps.proxy.mode.custom': '自訂代理',
  'miniApps.proxy.url': 'http://127.0.0.1:7890 或 socks5://127.0.0.1:1080',
  'miniApps.proxy.bypassRules': '略過規則（選填）',
  'miniApps.proxy.invalidUrl': '代理 URL 必須使用 http、https、socks、socks4 或 socks5。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 AiYo。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 AiYo，但與此應用程式版本不相容。請更新伺服器上的 AiYo 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 AiYo 伺服器與此應用程式版本不相容。請更新伺服器上的 AiYo 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutAiYo': '關於 AiYo',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 AiYo 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 AiYo',
  ...
  'aboutDialog.aiYoVersionLabel': 'AiYo 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 AiYo 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 AiYo',
  ...
  'header.actions.openAppMenu': 'AiYo 選單',
  'header.actions.openAppMenuAria': '開啟 AiYo 選單',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 AiYo',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 AiYo 伺服器之間切換',
  ...
  'multiRun.window.description': 'AiYo 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 AiYo',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 AiYo 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 AiYo 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 AiYo 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 AiYo 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 AiYo 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 AiYo。請確認位址是否指向 AiYo 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 AiYo。請確認位址是否指向 AiYo 伺服器。',
  ...
  'startup.initRecovery.description': 'AiYo 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 AiYo...',
  ...
  'updateDialog.actions.downloadDmg': '下載 DMG',
  'updateDialog.actions.updateNow': '立即更新',
  'updateDialog.status.updating': '更新中...',
  'updateDialog.error.updateFailed': '更新失敗',
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：aiyo update',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 AiYo 開啟。',

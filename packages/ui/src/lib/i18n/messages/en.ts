...
export const dict = {
  ...
  'miniApps.description': 'Open configured third-party web pages inside AiYo.',
  'miniApps.empty': 'No mini apps configured yet.',
  'miniApps.loadError': 'Unable to load mini apps.',
  'miniApps.form.name': 'App name',
  'miniApps.form.url': 'https://example.com',
  'miniApps.form.iconUrl': 'Icon URL (optional)',
  'miniApps.form.add': 'Add mini app',
  'miniApps.form.invalid': 'Enter a name and a valid HTTP or HTTPS URL.',
  'miniApps.form.invalidIconUrl': 'Icon URL must be a valid HTTP or HTTPS URL.',
  'miniApps.actions.open': 'Open {name}',
  'miniApps.actions.edit': 'Edit {name}',
  'miniApps.actions.delete': 'Delete {name}',
  'miniApps.actions.pin': 'Pin {name} to the sidebar',
  'miniApps.actions.unpin': 'Unpin {name} from the sidebar',
  'miniApps.actions.pinLimit': 'You can pin up to {count} mini apps.',
  'miniApps.viewer.back': 'Back',
  'miniApps.viewer.forward': 'Forward',
  ...
  'miniApps.viewer.minimize': 'Minimize viewer',
  'miniApps.viewer.switchTo': 'Switch to {name}',
  'miniApps.viewer.closeApp': 'Close {name}',
  'miniApps.proxy.title': 'Network proxy',
  'miniApps.proxy.description': 'Apply a proxy to mini app web pages in the desktop runtime.',
  'miniApps.proxy.mode': 'Mini app proxy mode',
  'miniApps.proxy.mode.none': 'No proxy',
  'miniApps.proxy.mode.system': 'System proxy',
  'miniApps.proxy.mode.custom': 'Custom proxy',
  'miniApps.proxy.url': 'http://127.0.0.1:7890 or socks5://127.0.0.1:1080',
  'miniApps.proxy.bypassRules': 'Bypass rules (optional)',
  'miniApps.proxy.invalidUrl': 'Proxy URL must use http, https, socks, socks4, or socks5.',
  ...
  'sessions.sidebar.footer.actions.aboutAiYo': 'About AiYo',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to AiYo — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop AiYo',
  ...
  'aboutDialog.aiYoVersionLabel': 'AiYo version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes AiYo state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate AiYo efficiently',
  ...
  'header.actions.openAppMenu': 'AiYo menu',
  'header.actions.openAppMenuAria': 'Open AiYo menu',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock AiYo',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote AiYo servers',
  ...
  'multiRun.window.description': 'AiYo Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to AiYo',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If AiYo does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of AiYo — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to AiYo settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an AiYo server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an AiYo server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different AiYo version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running AiYo but is not compatible with this app version. Update AiYo on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running AiYo. Verify the address points to an AiYo server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running AiYo. Verify the address points to an AiYo server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The AiYo server at "{host}" is not compatible with this app version. Update AiYo on the server, then try again.',
  ...
  'startup.initRecovery.description': 'AiYo could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating AiYo...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: aiyo update',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep AiYo open.',

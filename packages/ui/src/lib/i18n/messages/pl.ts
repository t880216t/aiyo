...
export const dict: Record<I18nKey, string> = {
  ...
  'common.save': 'Zapisz',
  'miniApps.title': 'Miniaplikacje',
  'miniApps.description': 'Otwieraj skonfigurowane strony internetowe innych firm w AiYo.',
  'miniApps.empty': 'Nie skonfigurowano jeszcze żadnych miniaplikacji.',
  'miniApps.loadError': 'Nie można załadować miniaplikacji.',
  'miniApps.form.name': 'Nazwa aplikacji',
  'miniApps.form.url': 'https://example.com',
  'miniApps.form.iconUrl': 'URL ikony (opcjonalnie)',
  'miniApps.form.add': 'Dodaj miniaplikację',
  'miniApps.form.invalid': 'Wpisz nazwę i prawidłowy adres HTTP lub HTTPS.',
  'miniApps.form.invalidIconUrl': 'URL ikony musi być prawidłowym adresem HTTP lub HTTPS.',
  'miniApps.actions.open': 'Otwórz {name}',
  'miniApps.actions.edit': 'Edytuj {name}',
  'miniApps.actions.delete': 'Usuń {name}',
  'miniApps.actions.pin': 'Przypnij {name} do paska bocznego',
  'miniApps.actions.unpin': 'Odepnij {name} od paska bocznego',
  'miniApps.actions.pinLimit': 'Możesz przypiąć maksymalnie {count} miniaplikacji.',
  'miniApps.viewer.back': 'Wstecz',
  'miniApps.viewer.forward': 'Dalej',
  'miniApps.viewer.reload': 'Odśwież',
  'miniApps.viewer.openExternal': 'Otwórz w przeglądarce zewnętrznej',
  'miniApps.viewer.openDevTools': 'Otwórz konsolę miniaplikacji',
  'miniApps.viewer.minimize': 'Zwiń podgląd',
  'miniApps.viewer.switchTo': 'Przełącz na {name}',
  'miniApps.viewer.closeApp': 'Zamknij {name}',
  'miniApps.proxy.title': 'Proxy sieciowe',
  'miniApps.proxy.description': 'Zastosuj proxy do stron web miniaplikacji w środowisku desktop.',
  'miniApps.proxy.mode': 'Tryb proxy miniaplikacji',
  'miniApps.proxy.mode.none': 'Bez proxy',
  'miniApps.proxy.mode.system': 'Proxy systemowe',
  'miniApps.proxy.mode.custom': 'Własne proxy',
  'miniApps.proxy.url': 'http://127.0.0.1:7890 lub socks5://127.0.0.1:1080',
  'miniApps.proxy.bypassRules': 'Reguły pomijania (opcjonalnie)',
  'miniApps.proxy.invalidUrl': 'URL proxy musi używać http, https, socks, socks4 albo socks5.',
  ...
  'pwa.installPrompt.description': 'Zainstaluj AiYo, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'AiYo został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutAiYo': 'O AiYo',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia AiYo.',
  ...
  'onboarding.chooser.title': 'Witaj w AiYo',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli AiYo nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień AiYo i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera AiYo aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer AiYo, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji AiYo. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia AiYo, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj AiYo na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim AiYo. Zweryfikuj czy adres wskazuje na serwer AiYo.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia AiYo. Zweryfikuj czy adres wskazuje na serwer AiYo.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer AiYo pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj AiYo na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'AiYo nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan AiYo, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.aiYoVersionLabel': 'Wersja AiYo {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do AiYo — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami AiYo',
  ...
  'header.actions.openAppMenu': 'Menu AiYo',
  'header.actions.openAppMenuAria': 'Otwórz menu AiYo',
  ...
  'header.services.shutdownDev': 'Zatrzymaj AiYo',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po AiYo.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj AiYo',
  ...
  'updateDialog.header.updating': 'Aktualizowanie AiYo...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw AiYo otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce AiYo — zainstaluj je, aby zacząć.',
  ...
  'settings.aiyo.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.aiyo.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.aiyo.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.aiyo.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.aiyo.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.aiyo.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.aiyo.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.aiyo.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',

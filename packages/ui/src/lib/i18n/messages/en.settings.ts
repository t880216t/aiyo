export const settingsDict = {
  ...
  'settings.window.description': 'AiYo settings window.',
  ...
  'settings.aiyo.tunnel.title': 'Remote Tunnel',
  'settings.aiyo.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.aiyo.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.aiyo.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.aiyo.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.aiyo.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.aiyo.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.aiyo.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.aiyo.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.aiyo.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.aiyo.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.aiyo.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.aiyo.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.aiyo.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.aiyo.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.aiyo.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.aiyo.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.aiyo.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.aiyo.tunnel.field.provider': 'Provider',
  'settings.aiyo.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.aiyo.tunnel.field.tunnelType': 'Tunnel type',
  'settings.aiyo.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.aiyo.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.aiyo.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.aiyo.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.aiyo.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.aiyo.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.aiyo.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.aiyo.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.aiyo.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.aiyo.tunnel.field.configurationFile': 'Configuration file',
  'settings.aiyo.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.aiyo.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.aiyo.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.aiyo.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.aiyo.tunnel.field.connectLink': 'Connect link',
  'settings.aiyo.tunnel.field.expires': 'Expires',
  'settings.aiyo.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.aiyo.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.aiyo.tunnel.actions.saveToken': 'Save token',
  'settings.aiyo.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.aiyo.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.aiyo.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.aiyo.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.aiyo.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.aiyo.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.aiyo.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.aiyo.tunnel.actions.stopping': 'Stopping...',
  'settings.aiyo.tunnel.actions.newConnectLink': 'New connect link',
  'settings.aiyo.tunnel.actions.copied': 'Copied',
  'settings.aiyo.tunnel.actions.retry': 'Retry',
  'settings.aiyo.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.aiyo.tunnel.option.mode.quick.label': 'Quick',
  'settings.aiyo.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.aiyo.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.aiyo.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.aiyo.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.aiyo.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.aiyo.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.aiyo.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  'settings.aiyo.tunnel.badge.quick': 'QUICK',
  'settings.aiyo.tunnel.badge.remote': 'REMOTE',
  'settings.aiyo.tunnel.badge.local': 'LOCAL',
  'settings.aiyo.tunnel.state.loading': 'Loading',
  'settings.aiyo.tunnel.state.expired': 'Expired',
  'settings.aiyo.tunnel.state.revoked': 'Revoked',
  'settings.aiyo.tunnel.state.inactive': 'Inactive',
  'settings.aiyo.tunnel.state.noExpiry': 'No expiry',
  'settings.aiyo.tunnel.state.never': 'Never',
  'settings.aiyo.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.aiyo.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.aiyo.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.aiyo.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.aiyo.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.aiyo.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/aiyo/cloudflare-managed-remote-tunnels.json.',
  'settings.aiyo.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.aiyo.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.aiyo.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.aiyo.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.aiyo.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.aiyo.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.aiyo.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.aiyo.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.aiyo.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.aiyo.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.aiyo.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.aiyo.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.aiyo.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.aiyo.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.aiyo.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.aiyo.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.aiyo.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.aiyo.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.aiyo.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.aiyo.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.aiyo.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.aiyo.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.aiyo.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.aiyo.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.aiyo.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.aiyo.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other AiYo servers',
  'settings.remoteInstances.direct.description': 'Add another AiYo server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another AiYo server.',
  'settings.remoteInstances.direct.import.placeholder': 'aiyo://connect?...',
  'settings.remoteInstances.direct.import.action': 'Import Link',
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid AiYo connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so AiYo Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether AiYo should start the server for you, or connect to one that is already running.',
  ...
  'settings.aiyo.about.title': 'About AiYo',
  'settings.aiyo.about.field.version': 'Version',
  'settings.aiyo.about.field.openCodeVersion': 'OpenCode version',
  'settings.aiyo.about.state.checking': 'Checking...',
  'settings.aiyo.about.state.upToDate': 'Up to date',
  'settings.aiyo.about.state.unknown': 'unknown',
  'settings.aiyo.about.actions.checkUpdates': 'Check updates',
  'settings.aiyo.about.actions.update': 'Update',
  'settings.aiyo.about.actions.updateToVersion': 'Update to {version}',
  'settings.aiyo.about.actions.checkForUpdates': 'Check for updates',
  'settings.aiyo.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. AiYo will scan it for folders containing',
  ...
  'settings.aiyo.passkeys.title': 'Passkeys',
  'settings.aiyo.passkeys.field.currentDevice': 'Current device',
  'settings.aiyo.passkeys.actions.add': 'Add passkey',
  'settings.aiyo.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.aiyo.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.aiyo.passkeys.actions.signingOut': 'Signing out…',
  'settings.aiyo.passkeys.actions.removing': 'Removing…',
  'settings.aiyo.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.aiyo.passkeys.state.loading': 'Loading passkeys…',
  'settings.aiyo.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.aiyo.passkeys.item.lastUsed': 'Last used {time}',
  'settings.aiyo.passkeys.item.added': 'Added {time}',
  'settings.aiyo.passkeys.time.neverUsed': 'Never used',
  'settings.aiyo.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.aiyo.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.aiyo.passkeys.toast.added': 'Passkey added',
  'settings.aiyo.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.aiyo.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.aiyo.passkeys.toast.removed': 'Passkey removed',
  'settings.aiyo.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.aiyo.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.aiyo.sessionRetention.title': 'Session Retention',
  'settings.aiyo.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.aiyo.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.aiyo.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.aiyo.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.aiyo.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.aiyo.sessionRetention.field.days': 'days',
  'settings.aiyo.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.aiyo.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.aiyo.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.aiyo.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.aiyo.sessionRetention.action.archive': 'Archive',
  'settings.aiyo.sessionRetention.action.delete': 'Delete',
  'settings.aiyo.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.aiyo.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.aiyo.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.aiyo.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.aiyo.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.aiyo.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.aiyo.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.aiyo.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.aiyo.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.aiyo.desktopNetwork.title': 'Desktop Network Access',
  'settings.aiyo.desktopNetwork.field.launchAtLoginAria': 'Start AiYo at login',
  'settings.aiyo.desktopNetwork.field.launchAtLogin': 'Start AiYo when you log in',
  'settings.aiyo.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.aiyo.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.aiyo.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.aiyo.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.aiyo.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.aiyo.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.aiyo.desktopPassword.field.password': 'Desktop UI Password',
  'settings.aiyo.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.aiyo.desktopPassword.field.passwordDescription': 'AiYo asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.aiyo.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.aiyo.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.aiyo.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.aiyo.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.aiyo.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.aiyo.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.aiyo.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.aiyo.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.aiyo.opencodeCli.title': 'OpenCode CLI',
  'settings.aiyo.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.aiyo.opencodeCli.tooltipSuffix': 'binary.',
  'settings.aiyo.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.aiyo.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.aiyo.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.aiyo.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.aiyo.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.aiyo.opencodeCli.actions.browse': 'Browse',
  'settings.aiyo.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.aiyo.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.aiyo.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.aiyo.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.aiyo.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.aiyo.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.aiyo.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.aiyo.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.aiyo.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.aiyo.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.aiyo.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.aiyo.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.aiyo.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.aiyo.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.aiyo.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.aiyo.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.aiyo.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.aiyo.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.aiyo.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.aiyo.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.aiyo.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.aiyo.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.aiyo.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.aiyo.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.aiyo.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.aiyo.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.aiyo.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.aiyo.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.aiyo.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.aiyo.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.aiyo.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.aiyo.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.aiyo.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.aiyo.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.aiyo.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.aiyo.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.aiyo.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open AiYo there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'AiYo on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how AiYo should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote AiYo server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote AiYo UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How AiYo should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingAiYo': 'Installing AiYo',
  'settings.remoteInstances.page.phase.updatingAiYo': 'Updating AiYo',
  ...
  'settings.aiyo.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.aiyo.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.aiyo.worktrees.setup.title': 'Setup commands',
  'settings.aiyo.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.aiyo.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.aiyo.worktrees.setup.loading': 'Loading...',
  'settings.aiyo.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.aiyo.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.aiyo.worktrees.setup.addCommand': 'Add command',
  'settings.aiyo.worktrees.list.title': 'Existing worktrees',
  'settings.aiyo.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.aiyo.worktrees.list.loading': 'Loading worktrees...',
  'settings.aiyo.worktrees.list.empty': 'No worktrees found for this project',
  'settings.aiyo.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.aiyo.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.description': 'Add an OpenAI-compatible provider by writing it to your OpenCode configuration.',
  'settings.providers.page.custom.providerIdLabel': 'Provider ID',
  'settings.providers.page.custom.providerIdPlaceholder': 'my-provider',
  'settings.providers.page.custom.nameLabel': 'Display Name',
  'settings.providers.page.custom.namePlaceholder': 'My Provider',
  ...
  'settings.providers.page.custom.modelsLabel': 'Models',
  'settings.providers.page.custom.modelsPlaceholder': 'model-one\nmodel-two',
  'settings.providers.page.custom.apiKeyLabel': 'API Key',
  'settings.providers.page.custom.apiKeyPlaceholder': 'Optional',
  'settings.providers.page.custom.scopeLabel': 'Save to',
  'settings.providers.page.custom.scopeUser': 'User',
  'settings.providers.page.custom.scopeProject': 'Project',
  'settings.providers.page.custom.createButton': 'Add Custom Provider',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by AiYo.',
  ...
  'settings.providers.page.toast.customProviderRequired': 'Provider ID, name, base URL, and at least one model are required',
  'settings.providers.page.toast.customProviderCreated': 'Custom provider added',
  'settings.providers.page.toast.customProviderCreateFailed': 'Failed to add custom provider',
  'settings.providers.page.toast.customProviderUpdated': 'Custom provider updated',
  'settings.providers.page.toast.customProviderUpdateFailed': 'Failed to update custom provider',
  ...
  'settings.aiyo.defaults.title': 'Session Defaults',
  'settings.aiyo.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.aiyo.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.aiyo.defaults.field.defaultModel': 'Default Model',
  'settings.aiyo.defaults.field.defaultThinking': 'Default Thinking',
  'settings.aiyo.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.aiyo.defaults.field.defaultAgent': 'Default Agent',
  'settings.aiyo.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.aiyo.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.aiyo.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.aiyo.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.aiyo.defaults.option.default': 'Default',
  'settings.aiyo.defaults.option.defaultLowercase': 'default',
  'settings.aiyo.git.title': 'Git Preferences',
  'settings.aiyo.git.changesViewTitle': 'Changes View',
  'settings.aiyo.git.changesViewAria': 'Git changes view mode',
  'settings.aiyo.git.option.flatList': 'Flat List',
  'settings.aiyo.git.option.treeView': 'Tree View',
  'settings.aiyo.git.optionAria': 'Git changes view mode: {option}',
  'settings.aiyo.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.aiyo.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.aiyo.git.showGitignoredAria': 'Display gitignored files',
  'settings.aiyo.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize AiYo',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if AiYo auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from AiYo.',
  ...
  'settings.aiyo.visual.section.colorMode': 'Color Mode',
  'settings.aiyo.visual.section.mobileLayout': 'Mobile Layout',
  'settings.aiyo.visual.option.mobileLayout.default': 'Old',
  'settings.aiyo.visual.option.mobileLayout.new': 'New',
  'settings.aiyo.visual.section.localization': 'Localization',
  'settings.aiyo.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.aiyo.visual.section.navigation': 'Navigation',
  'settings.aiyo.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.aiyo.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.aiyo.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.aiyo.visual.section.activityDefault': 'Activity Default',
  'settings.aiyo.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.aiyo.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.aiyo.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.aiyo.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.aiyo.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.aiyo.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.aiyo.visual.section.diffLayout': 'Diff Layout',
  'settings.aiyo.visual.section.diffLayoutAria': 'Diff layout',
  'settings.aiyo.visual.section.privacy': 'Privacy',
  'settings.aiyo.visual.field.lightTheme': 'Light Theme',
  'settings.aiyo.visual.field.darkTheme': 'Dark Theme',
  'settings.aiyo.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.aiyo.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.aiyo.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.aiyo.visual.field.timeFormat': 'Time Format',
  'settings.aiyo.visual.field.weekStartsOn': 'Week Starts On',
  'settings.aiyo.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.aiyo.visual.field.selectWeekStartAria': 'Select week start',
  'settings.aiyo.visual.actions.reloadThemes': 'Reload themes',
  'settings.aiyo.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.aiyo.visual.field.macVibrancy': 'Window transparency',
  'settings.aiyo.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.aiyo.visual.actions.saveAndRestart': 'Save & restart',
  'settings.aiyo.visual.actions.restarting': 'Restarting…',
  'settings.aiyo.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.aiyo.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/aiyo/themes/',
  'settings.aiyo.visual.field.installAppName': 'Install App Name',
  'settings.aiyo.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.aiyo.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.aiyo.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.aiyo.visual.field.installOrientation': 'Install Orientation',
  'settings.aiyo.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.aiyo.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.aiyo.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.aiyo.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.aiyo.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.aiyo.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.aiyo.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.aiyo.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.aiyo.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.aiyo.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.aiyo.visual.field.interfaceFont': 'Interface Font',
  'settings.aiyo.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.aiyo.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.aiyo.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.aiyo.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.aiyo.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.aiyo.visual.field.codeFont': 'Code Font',
  'settings.aiyo.visual.field.selectCodeFontAria': 'Select code font',
  'settings.aiyo.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.aiyo.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.aiyo.visual.field.spacingDensity': 'Spacing Density',
  'settings.aiyo.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.aiyo.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.aiyo.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.aiyo.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.aiyo.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.aiyo.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.aiyo.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.aiyo.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.aiyo.visual.option.fileEditorKeymap.default': 'Default',
  'settings.aiyo.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.aiyo.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.aiyo.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.aiyo.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.aiyo.visual.field.bash': 'Bash',
  'settings.aiyo.visual.field.editTools': 'Edit tools',
  'settings.aiyo.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.aiyo.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.aiyo.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.aiyo.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.aiyo.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.aiyo.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.aiyo.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.aiyo.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.aiyo.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.aiyo.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.aiyo.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.aiyo.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.aiyo.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.aiyo.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.aiyo.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.aiyo.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.aiyo.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.aiyo.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.aiyo.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.aiyo.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.aiyo.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.aiyo.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.aiyo.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.aiyo.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.aiyo.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.aiyo.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.aiyo.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.aiyo.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.aiyo.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.aiyo.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.aiyo.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.aiyo.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.aiyo.visual.option.themeMode.system': 'System',
  'settings.aiyo.visual.option.themeMode.light': 'Light',
  'settings.aiyo.visual.option.themeMode.dark': 'Dark',
  'settings.aiyo.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.aiyo.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.aiyo.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.aiyo.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.aiyo.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.aiyo.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.aiyo.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.aiyo.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.aiyo.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.aiyo.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.aiyo.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.aiyo.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.aiyo.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.aiyo.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.aiyo.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.aiyo.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.aiyo.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.aiyo.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.aiyo.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.aiyo.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.aiyo.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.aiyo.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.aiyo.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.aiyo.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.aiyo.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.aiyo.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.aiyo.visual.option.chatRenderMode.live.label': 'Live',
  'settings.aiyo.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.aiyo.visual.option.messageTransport.auto.label': 'Auto',
  'settings.aiyo.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.aiyo.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.aiyo.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.aiyo.visual.option.messageTransport.sse.label': 'SSE',
  'settings.aiyo.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.aiyo.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.aiyo.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.aiyo.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.aiyo.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.aiyo.visual.option.timeFormat.auto.label': 'Auto',
  'settings.aiyo.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.aiyo.visual.option.timeFormat.24h.label': '24-hour',
  'settings.aiyo.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.aiyo.visual.option.timeFormat.12h.label': '12-hour',
  'settings.aiyo.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.aiyo.visual.option.weekStart.auto.label': 'Auto',
  'settings.aiyo.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.aiyo.visual.option.weekStart.monday.label': 'Monday',
  'settings.aiyo.visual.option.weekStart.sunday.label': 'Sunday',

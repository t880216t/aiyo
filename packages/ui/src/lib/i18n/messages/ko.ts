...
export const dict: Record<I18nKey, string> = {
  ...
  'common.save': '저장',
  'miniApps.title': '미니 앱',
  'miniApps.description': '설정한 타사 웹 페이지를 AiYo 안에서 엽니다.',
  'miniApps.empty': '설정된 미니 앱이 없습니다.',
  'miniApps.loadError': '미니 앱을 불러올 수 없습니다.',
  'miniApps.form.name': '앱 이름',
  'miniApps.form.url': 'https://example.com',
  'miniApps.form.iconUrl': '아이콘 URL(선택 사항)',
  'miniApps.form.add': '미니 앱 추가',
  'miniApps.form.invalid': '이름과 유효한 HTTP 또는 HTTPS URL을 입력하세요.',
  'miniApps.form.invalidIconUrl': '아이콘 URL은 유효한 HTTP 또는 HTTPS URL이어야 합니다.',
  'miniApps.actions.open': '{name} 열기',
  'miniApps.actions.edit': '{name} 편집',
  'miniApps.actions.delete': '{name} 삭제',
  'miniApps.actions.pin': '{name}을(를) 사이드바에 고정',
  'miniApps.actions.unpin': '사이드바에서 {name} 고정 해제',
  'miniApps.actions.pinLimit': '미니 앱은 최대 {count}개까지 고정할 수 있습니다.',
  'miniApps.viewer.back': '뒤로',
  'miniApps.viewer.forward': '앞으로',
  'miniApps.viewer.reload': '새로고침',
  'miniApps.viewer.openExternal': '외부 브라우저에서 열기',
  'miniApps.viewer.openDevTools': '미니 앱 콘솔 열기',
  'miniApps.viewer.minimize': '뷰어 접기',
  'miniApps.viewer.switchTo': '{name}(으)로 전환',
  'miniApps.viewer.closeApp': '{name} 닫기',
  'miniApps.proxy.title': '네트워크 프록시',
  'miniApps.proxy.description': '데스크톱 런타임에서 미니 앱 웹 페이지에 프록시를 적용합니다.',
  'miniApps.proxy.mode': '미니 앱 프록시 모드',
  'miniApps.proxy.mode.none': '프록시 없음',
  'miniApps.proxy.mode.system': '시스템 프록시',
  'miniApps.proxy.mode.custom': '사용자 지정 프록시',
  'miniApps.proxy.url': 'http://127.0.0.1:7890 또는 socks5://127.0.0.1:1080',
  'miniApps.proxy.bypassRules': '우회 규칙(선택 사항)',
  'miniApps.proxy.invalidUrl': '프록시 URL은 http, https, socks, socks4 또는 socks5를 사용해야 합니다.',
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 AiYo를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'AiYo가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutAiYo': 'AiYo 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 AiYo에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'AiYo 종료',
  ...
  'aboutDialog.aiYoVersionLabel': 'AiYo 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'AiYo 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 AiYo를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'AiYo 메뉴',
  'header.actions.openAppMenuAria': 'AiYo 메뉴 열기',
  ...
  'sessionAuth.locked.unlockTitle': 'AiYo 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 AiYo 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'AiYo 멀티런 창.',
  ...
  'onboarding.chooser.title': 'AiYo에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'AiYo가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 AiYo의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'AiYo 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 AiYo 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 AiYo 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 AiYo 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 AiYo가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 AiYo를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 AiYo가 실행 중이 아닙니다. 주소가 AiYo 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 AiYo가 실행 중이 아닙니다. 주소가 AiYo 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 AiYo 서버가 이 앱 버전과 호환되지 않습니다. 서버의 AiYo를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'AiYo 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'AiYo 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `aiyo update`를 실행하세요.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'AiYo를 열어 두세요.',

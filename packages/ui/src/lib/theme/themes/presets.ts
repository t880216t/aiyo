...
import aiyo_dark_Raw from './fields-of-the-shire-dark.json';
import aiyo_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  aiyo_dark_Raw as Theme,
  aiyo_light_Raw as Theme,

...
const uiPort = process.env.AIYO_HMR_UI_PORT || '5180';
const backendPort = process.env.AIYO_HMR_API_PORT || '3902';
const hmrHost = process.env.AIYO_HMR_HOST || '127.0.0.1';

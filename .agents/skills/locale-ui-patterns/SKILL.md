...
description: Use when creating or modifying AiYo UI text, labels, buttons, placeholders, aria labels, empty states, toasts, dialogs, settings copy, navigation labels, or any user-facing strings.
---
...
'chat.input.placeholder': 'Ask AiYo...'
```
...
- Product names: `AiYo`, `OpenCode`, `GitHub`
